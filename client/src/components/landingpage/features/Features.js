...
const featuresData = [
  {
    ...
    subtext: 'We have included 6 pre-defined Theme Colors with IG AutomationAdmin.',
  },
  {
  ...
  },
  {
    ...
    subtext: 'Almost 45+ UI Components being given with IG AutomationAdmin Pack.',
  },
  {
    icon: <IconPresentation width={40} height={40} strokeWidth={1.5} />,
    title: '4+ Frontend Pages',
    subtext: 'We have added useful frontend pages with IG AutomationAdmin',
  },
  {
  ...
  },
  {
    ...
    subtext: 'Lots of Icon Fonts are included here in the package of IG AutomationAdmin.',
  },
  {
